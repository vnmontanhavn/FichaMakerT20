...
class PdfViewController: UIViewController {
    var pdfView = PDFView()
    var char = SheetBuilder().crateSheetData()
    ...
    override func viewDidLoad() {
        ...
        handler.pdfPreview(pdfData: handler.generatePDF(characterSheet: char), view: &pdfView)
        setupConstraints()
        title = "Minha Ficha"
    ...
    func addTapped(){
        ...
        guard let documentURL = PdfHandler().generatePDF(characterSheet: char).dataToFile(fileName: "ficha.pdf") else {
            return
        }
